namespace MxAutomation_Example{
	partial class MainView {
		...
		private void InitializeComponent() {
			...
			this.button2.Click += new System.EventHandler(this.buttonStopReadKukaFile_Click);
			// 
			// label15
			// 
			...
			this.bStartReadKukFile.Click += new System.EventHandler(this.buttonStartReadKukaFile_Click);
			// 
			// bChangeKukFile
			// 
			...
			this.button1.Click += new System.EventHandler(this.bMoveToPos3_Click);
			// 
			// MainView
			// 
			this.AllowDrop = true;
